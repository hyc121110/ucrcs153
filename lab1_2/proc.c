...
scheduler(void)
{
  ...
  for(;;){
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      ...
      // ========== lab2 =============== 
      // highest_p  == low number EX. 10 20 30 we need to pick up 10
...
// added by Shiyao Feng lab2 
void
setpriority(int p_val)
{
